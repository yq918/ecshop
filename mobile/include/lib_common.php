 ...
 * @return  商品最终购买价格
 */
function get_final_price($goods_id, $goods_num = '1', $is_spec_price = false, $spec = array(), $plus=false)
{
    ...
    if ($plus) {
    	$user_price    = plus_price($user_price, $goods_id);
    }  else {
    	$user_price    = plus_price_cart($user_price, $goods_id);
    }
