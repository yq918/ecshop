...
<dl class="user_top">
  <dt> <?php if ($this->_var['info']['head_url'] != ''): ?><img src="<?php echo $this->_var['info']['head_url']; ?>"><?php else: ?><img src="<?php echo $this->_var['ectouch_themes']; ?>/images/get_avatar.png"><?php endif; ?> </dt>
  <dd>
     <p><?php if ($this->_var['info']['nick_name']): ?><?php echo $this->_var['info']['nick_name']; ?><?php else: ?><?php echo $this->_var['info']['user_name']; ?><?php endif; ?></p>
    <p><span style="font-weight:bold">关注时间：<?php if ($this->_var['info']['is_subscribe']): ?><?php echo $this->_var['info']['subscribe_time']; ?><?php else: ?>未关注<?php endif; ?></span></p>
  </dd>
...
<section class="wrap">
  ...
  <div class="blank3"></div>
  <div class="list_box padd1 radius10" style="padding-top:0;padding-bottom:0;"> 
  <?php if ($this->_var['info']['is_distributor']): ?><a href="distribute.php" class="clearfix"> <span>我的店铺</span><i></i> </a><?php endif; ?>
  <a href="user.php?act=message_list" class="clearfix"> <span><?php echo $this->_var['lang']['label_message']; ?></span><i></i> </a> <a href="user.php?act=comment_list"  class="clearfix"> <span><?php echo $this->_var['lang']['label_comment']; ?></span><i></i> </a> </div>
  <div class="blank3"></div>
  <div class="list_box padd1 radius10" style="padding-top:0;padding-bottom:0;"> 
...
<section class="wrap message_list">
  ...
  <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
    <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
      ...
      <tr>
        <td> <?php echo $this->_var['lang']['order_number']; ?> <a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/uchange/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
