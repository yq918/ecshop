...
<div class="tab-div">
    ...
    <div id="tabbar-div">
      <p>
        ...
        class="tab-back" id="plus-tab"><?php echo $this->_var['lang']['tab_plus']; ?></span>
      </p>
    </div>
...
?>
        ...
        <table width="90%" id="plus-table" style="display:none" align="center">
         <tr>
            <td class="label">是否启用粉丝营销：</td>
            <td><input type="radio" name="plus[]" value="1" <?php if ($this->_var['goods']['goods_plus']['0'] == 1): ?>checked<?php endif; ?>>是<input type="radio" name="plus[]" value="0" <?php if ($this->_var['goods']['goods_plus']['0'] == 0): ?>checked<?php endif; ?>>否</td>
          </tr>
         <tr>
            <td class="label">基本价格：</td>
            <td><input type="text" name="plus[]" size="20" value="<?php echo $this->_var['goods']['goods_plus']['1']; ?>"/></td>
          </tr>
         <tr>
            <td class="label">普通会员加价：</td>
            <td><input type="text" name="plus[]" size="20" value="<?php echo $this->_var['goods']['goods_plus']['2']; ?>"/> 粉丝: [0,<?php echo $this->_var['plus_middle_price_num']; ?>)</td>
          </tr>
         <tr>
            <td class="label">中级会员加价：</td>
            <td><input type="text" name="plus[]" size="20" value="<?php echo $this->_var['goods']['goods_plus']['3']; ?>"/> 粉丝: [<?php echo $this->_var['plus_middle_price_num']; ?>, <?php echo $this->_var['plus_supper_price_num']; ?>)</td>
          </tr>
         <tr>
            <td class="label">高级会员加价：</td>
            <td><input type="text" name="plus[]" size="20" value="<?php echo $this->_var['goods']['goods_plus']['4']; ?>"/> 粉丝: [<?php echo $this->_var['plus_supper_price_num']; ?>, n)</td>
          </tr>
         <tr>
            <td class="label">加价系数（百分比）：</td>
            <td><input type="text" name="plus[]" size="20" value="<?php if ($this->_var['goods']['goods_plus']['5']): ?><?php echo $this->_var['goods']['goods_plus']['5']; ?><?php else: ?><?php endif; ?>"/> 如：40%，最终价格=基本价格+加价-（加价×加价系数）×优惠系数</td>
          </tr>
         <tr>
            <td class="label">优惠系数（百分比）：</td>
            <td><input type="text" name="plus[]" size="20" value="<?php if ($this->_var['goods']['goods_plus']['6']): ?><?php echo $this->_var['goods']['goods_plus']['6']; ?><?php else: ?><?php endif; ?>"/> 如：60%，上级返现=（加价×加价系数）×（1-优惠系数）</td>
          </tr>
        </table>        
