  ...
  <tr><td>
    ...
    <table>
      ...
      <tr>
        ...
        <td valign="top"><strong><span id="templateName">程序版本V2.3</span></strong><span id="templateVersion"></span><br />

          <span id="templateAuthor"><a href="<?php echo $this->_var['curr_template']['uri']; ?>" target="_blank">码哥分销</a></span><br />

          <span id="templateDesc">企业高级版</span><br />
