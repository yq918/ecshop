<!-- $Id: wxch_oauth.html 2014-1-25 09:59:06Z djks $ -->
...
<h1>
<span class="action-span"><a href="wxch_oauth.php?act=add">添加跳转网址</a></span>
...
<div class="form-div">
  <form action="javascript:searchArticle()" name="searchForm" action="wxch_oauth.php" >
...
<form method="POST" action="wxch_oauth.php?act=batch_remove" name="listForm">
<!-- start cat list -->
...
<table cellspacing='1' cellpadding='3' id='list-table'>
  <tr>
    ...
    <th><a href="javascript:listTable.sort('article_type'); ">网址</a></th>
    <th><a href="#">调用网址</a></th>
...
?>
    ...
    <td align="left"><span><?php echo $this->_var['list']['contents']; ?></span></td>
    <td align="left"><span><?php echo $this->_var['list']['oauthurl']; ?></span></td>
    <td align="center"><?php echo $this->_var['list']['count']; ?></td>
    <td align="center" nowrap="true"><span>
      <a href="wxch_oauth.php?act=edit&oid=<?php echo $this->_var['list']['oid']; ?>" title="编辑"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>&nbsp;
     <!--  --><a href="#" onclick="listTable.remove(<?php echo $this->_var['list']['oid']; ?>, '您确认要删除这个规则吗？')" title="移除"><img src="images/icon_drop.gif" border="0" height="16" width="16"></a><!--  --></span>
    </td>
   </tr>
